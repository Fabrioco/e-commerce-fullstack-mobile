...
export default function Cart() {
  return (
    ...
    //     <Text className="text-4xl h-10 text-white font-bold text-center border-b-white border-b ">
    //       CARRINHO
    //     </Text>
    ...
    <StripeProvider publishableKey="pk_test_51Pk7m8P9KYnbHtuSYkCfqkXMjAVjHaZJcTa9ItfjRtdxPrpsPEIlM0Nan2FkIks5VPTOPSu6HPx6Z2RvMdeHkHB400nw9mXkxD">
      <View className="flex-1 flex flex-col items-center justify-center bg-[#074740]">
